    ...
    public events: Array<Event> = [
        {
            ...
            date: new Date(2019, 6, 10, 17, 0, 0),
        },
        {
            type: 'conference',
            title: 'Serverless Days',
            link: 'https://london.serverlessdays.io',
            date: new Date(2019, 6, 11, 10, 0, 0),
        },
        {
            type: 'stream',
